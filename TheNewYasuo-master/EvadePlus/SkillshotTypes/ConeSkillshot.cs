...
namespace MYasuoBuddy.EvadePlus.SkillshotTypes
{
    class ConeSkillshot : EvadeSkillshot
    {
        ...
        public Vector3 CurrentPos
        {
            get
            {
                ...
                {
                    float speed = SpellData.MissileSpeed;
                    float timeElapsed = Environment.TickCount - TimeDetected - SpellData.Delay;
        ...
        {
            var newInstance = new ConeSkillshot { SpellData = SpellData };
            if (debug)
            {
        ...
        public override void OnCreateObject(GameObject obj)
        {
            ...
            {
                if (missile.SData.Name == SpellData.ObjectCreationName && missile.SpellCaster.Index == Caster.Index)
                {
                    IsValid = false;
                }
            }
        ...
        public override void OnSpellDetection(Obj_AI_Base sender)
        {
            ...
            _FixedEndPos = _FixedStartPos.ExtendVector3(CastArgs.End, SpellData.Range);
        }
        ...
        public override Geometry.Polygon ToPolygon()
        {
            ...
            for (float i = -SpellData.ConeAngle / 2f; i <= SpellData.ConeAngle / 2f; i++)
            {
        ...
        public override int GetAvailableTime(Vector2 pos)
        {
            ...
            if (Missile == null)
            {
                return Math.Max(0, SpellData.Delay - (Environment.TickCount - TimeDetected));
            }
        ...
        public override bool IsSafePath(Vector2[] path, int timeOffset = 0, int speed = -1, int delay = 0)
        {
            ...
            var timeToExplode = Environment.TickCount - TimeDetected + SpellData.Delay;
