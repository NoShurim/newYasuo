...
namespace YasuoBuddy.EvadePlus
{
    public class EvadePlus
    {
        ...
        {
            get { return EvadeMenu.ControlsMenu["dodgeOnlyDangerous"].Cast<KeyBind>().CurrentValue || EvadeMenu.ControlsMenu["dodgeOnlyDangeroustoggle"].Cast<KeyBind>().CurrentValue; }
        }
