...
namespace YasuoBuddy
{
    class YasuoWall
    {
        public static Vector2 spotA = new Vector2(11070, 6908);
        ...
        public static Vector2 spotP = new Vector2(6830, 5500);
        public static Vector2 spotE = new Vector2(8322, 2658);
        //public static Vector2 spotF = new Vector2(3700, 7968);
        ...
        public static void WallDash()
        {
            ...
            if (Variables._Player.Distance(spotD) <= 130)
            {
            ...
            if (Variables._Player.Distance(spotP) <= 150)
            {
                MoveToLimited(spotP.To3D());
                ...
                foreach (var jungleMobs in jminions.Where(x => x.IsValidTarget(100)))
                {
                    ...
                    if (Variables._Player.Distance(spotP.To3D()) == 0 && jungleMobs.BaseSkinName != "SRU_Razorbreak" && jungleMobs.BaseSkinName != "SRU_Razorbreak" && jungleMobs.BaseSkinName != "SRU_Razorbreak" && jungleMobs.IsVisible && Yasuo.E.IsReady() && jungleMobs != null && jungleMobs.IsValidTarget(Yasuo.E.Range) && Variables.CanCastE(jungleMobs))
                    {
                        Yasuo.E.Cast(jungleMobs);
                    }
                }
            ...
            /*if (Variables._Player.Distance(spotF) <= 400)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.IsValidTarget(Yasuo.E.Range)))
                {
                    ...
                    if (Variables._Player.Distance(spotF.To3D()) == 0 && jungleMobs.BaseSkinName != "SRU_Blue" && jungleMobs.BaseSkinName != "SRU_BlueMini1.1.1" && jungleMobs.IsVisible && Yasuo.E.IsReady() && jungleMobs != null && jungleMobs.IsValidTarget(Yasuo.E.Range) && Variables.CanCastE(jungleMobs))
                    {
                        Yasuo.E.Cast(jungleMobs);
                    }
                }
            ...
            /*if (Variables._Player.Distance(spotK) <= 600)
            {
                MoveToLimited(spotK.To3D());
                ...
                foreach (var jungleMobs in jminions.Where(x => x.IsValidTarget(Variables._Player.AttackRange)))
                {
                    ...
                    if (Variables._Player.Distance(spotK.To3D()) == 0 && jungleMobs.BaseSkinName != "SRU_Murkwolf" && jungleMobs.BaseSkinName != "SRU_MurkwolfMini2.1.1" && jungleMobs.IsVisible && Yasuo.E.IsReady() && jungleMobs != null && jungleMobs.IsValidTarget(Yasuo.E.Range) && Variables.CanCastE(jungleMobs))
                    {
                        Yasuo.E.Cast(jungleMobs);
                    }
                }
            ...
            if (Variables._Player.Distance(spotN) <= 600)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.IsValidTarget(100)))
                {
                    ...
                    if (Variables._Player.Distance(spotN.To3D()) == 0 && jungleMobs.BaseSkinName != "SRU_RazorbreakMini" && jungleMobs.BaseSkinName != "SRU_RazorbreakMini" && jungleMobs.BaseSkinName != "SRU_Razorbreak" && jungleMobs.IsVisible && Yasuo.E.IsReady() && jungleMobs != null && Variables.CanCastE(jungleMobs))
                    {
                        Yasuo.E.Cast(jungleMobs);
                    }
                }
